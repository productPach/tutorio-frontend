  ...
  return (
    <>
      ...
      <RepetitorsServer
        ...
        total={tutorsData.pagination.total}
        page={tutorsData.pagination.page}
        pages={tutorsData.pagination.pages}
        subject={tutorsData.subject || undefined}
        goal={
          tutorsData.goal
            ? {
                title: tutorsData.goal.title,
                for_request: tutorsData.goal.for_request,
                for_chpu: tutorsData.goal.goalSlug,
              }
            : undefined
        }
