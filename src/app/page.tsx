  ...
  <main>
    ...
    <section className={clsx(styles.firstSection, styles.center)}>
      ...
      <div className={styles.firstSection__snippetSearch}>
        <div className={clsx(styles.firstSection__snippet, styles.snippetMedium)}>
          Подготовка к ЕГЭ
          <p>
        ...
        <div className={clsx(styles.firstSection__snippet, styles.snippetSmall)}>
          Начальная школа
          <Image
    ...
    <section className={clsx(styles.howWork, styles.center)}>
      ...
      <div className={styles.howWork__step}>
        ...
        <div className={styles.stepDescription}>
          ...
          <p className={styles.howWork__text}>
            Покажем заказ подходящим репетиторам. <span>Они напишут</span>, если
            готовы помочь, а вы <span>сможете уточнить</span> у них все детали{" "}
            <span>напрямую в чате</span>
          </p>
        </div>
        <div>
          <Image
      ...
      <div className={styles.howWork__step}>
        ...
        <div className={styles.stepDescription}>
          ...
          <p className={styles.howWork__text}>
            <span>Выберите репетиторов</span>, которые подходят под ваши критерии,
            обменяйтесь контактами и <span>приступите к занятиям</span>
          </p>
        </div>
        <div>
          <Image
      ...
      <div className={styles.howWork__step}>
        ...
        <div className={styles.stepDescription}>
          ...
          <p className={styles.howWork__text}>
            ...
            поделиться впечатлениями о результатах или <span>оставить отзыв</span>{" "}
            о сервисе
          </p>
        </div>
        <div>
      ...
      <div className={styles.feedbacks__container}>
        <div className={styles.feedbacks__container__feedback1}>
          ...
          <p className={styles.feedbacks__container__text}>
            Илона Михайловна как преподаватель мне очень нравится! Она помогает
            мне подтянуть английский язык, имеет интересную программу занятий,
            грамотно строит урок, всегда подстраивается под мой график, умеет
            проявить понимание, гибкость. Мне нравится, как Илона Михайловна
            преподносит материал, использует в работе различные аудиоподборки и
            видеозаписи, дополнительные учебные пособия. И профессиональные, и
            личностные качества репетитора находятся на высоте! Успехи есть,
            динамика занятий положительная! Благодаря Илоне Михайловне я начала
            гораздо лучше понимать английский язык, стала более уверенной в
            общении!
          </p>
        ...
        <div className={styles.feedbacks__container__feedback2}>
          ...
          <p className={styles.feedbacks__container__text}>
            Спасибо большое Максиму Сергеевичу! Сдали ОГЭ на 93 балла благодаря
            его работе. Очень ответственный и грамотный преподаватель.
          </p>
        ...
        <div className={styles.feedbacks__container__feedback3}>
          ...
          <p className={styles.feedbacks__container__text}>
            ...
            английский с нуля, так как в младших классах был странный и непонятный
            учитель. С помощью Ники смог разобраться во всех 12-ти временах,
            перетопил боязнь говорить и подготовился к технике написания письма.
            Планирую и дальше заниматься с этим чудесным преподавателем по скайпу,
            так как хочу подготовиться к сдаче огэ.
          </p>
        ...
        <div className={styles.feedbacks__container__feedback3}>
          ...
          <p className={styles.feedbacks__container__text}>
            ...
            позитивный. Мальчик не охотно любит заниматься, а к ней охотно идет.
            Она с детьми находит свой контакт, это плюс. Успеваемость повысилась,
            мы довольны, несмотря на то, что далеко. Технику она нам поставила, а
            дальше пока будем самостоятельно заниматься. Сказала на что обратить
            внимание и как правильно заниматься, какими источниками пользоваться,
            как руку ставить мальчику. Занимались недолго, но сдвиги есть.
          </p>
        ...
        <div className={styles.feedbacks__container__feedback4}>
          ...
          <p className={styles.feedbacks__container__text}>
            Мария Игореана занималась с ребенком и за 6 месяцев помогла "догнать"
            одноклассников, так как сильно отставал при переходе в новую школу.
            Большое спасибо.
          </p>
          <span className={styles.feedbacks__container__name}>Кирилл</span>
        </div>
        <div className={styles.feedbacks__container__feedback4}>
          ...
          <p className={styles.feedbacks__container__text}>
            Для нас с сыном Татьяна Львовна открыла целый мир. Дала консультацию
            по нашим диагнозам, проверила все возможности ребёнка, и определила
            его сложности.
          </p>
    ...
    <footer className={clsx(styles.footer, styles.center)}>
      <div className={styles.footer__left}>
        ...
        <div className={styles.footer__copiright}>
          © 2011–2024, ООО «Туторио». При использовании материалов гиперссылка на
          tutorio.ru обязательна. ИНН 7710718303, ОГРН 1087746642774. 109544, г.
          Москва, бульвар Энтузиастов, дом 2, 26 этаж.
        </div>
        <div className={styles.footer__description}>
          ООО «Туторио» осуществляет деятельность в сфере IT: сервис предоставляет
          онлайн - услуги по подбору финансовых продуктов, а также распространению
          рекламы организаций - партнеров в сети Интернет
        </div>
