...
const links = [
  { label: "Заказы", href: "/tutor/orders" },
  { label: "Отклики", href: "/tutor/responses" },
  { label: "Анкета", href: "/tutor/profile" },
  { label: "Баланс", href: "/tutor/wallet" },
  { label: "Настройки", href: "/tutor/settings" },
  { label: "Помощь", href: "/tutor/wiki" },
];
