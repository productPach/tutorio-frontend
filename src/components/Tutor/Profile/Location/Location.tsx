...
export const Location = () => {
  ...
  const initialCheckboxValue: string[] = tutor?.tutorPlace || [];
  const initialCheckboxTripValue: string[] = tutor?.tutorTrip || [];
  ...
  return (
    <>
      ...
      <div className={styles.wrap}>
        <div className={styles.title}>Какой то заголовок</div>
