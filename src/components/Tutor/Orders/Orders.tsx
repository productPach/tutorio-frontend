    ...
    <>
      {activeOrders.length > 0 ? (
        ...
        <div className={clsx(styles.content_block, styles.info_block)}>
          ...
          <p className={styles.content_block_p}>
            К сожалению, сейчас нет заказов, которые подходят под ваши условия.
            Пожалуйста, упростите критерии поиска в меню фильтров справа.
          </p>
          <p>
            Добавьте дополнительные предметы, которые вы преподаете. Это поможет
            увеличить количество доступных заказов.
          </p>
